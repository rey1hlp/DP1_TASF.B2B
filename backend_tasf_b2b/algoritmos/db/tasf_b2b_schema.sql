...
CREATE TABLE simulation_run (
  ...
  inicio CHAR(8) NULL,
  inicio_local VARCHAR(19) NULL,
  inicio_utc DATETIME NULL,
  inicio_utc_minute INT NULL,
  fin CHAR(8) NULL,
  dias INT NULL,
...
CREATE TABLE simulation_virtual_cancellation (
  id BIGINT NOT NULL AUTO_INCREMENT,
  simulation_id VARCHAR(64) NOT NULL,
  flight_id BIGINT NOT NULL,
  fecha_cancelacion DATE NOT NULL,
...
CREATE TABLE simulation_report_snapshot (
  id BIGINT NOT NULL AUTO_INCREMENT,
...
CREATE TABLE simulation_report_metric (
  id BIGINT NOT NULL AUTO_INCREMENT,
...
CREATE TABLE simulation_report_route (
  id BIGINT NOT NULL AUTO_INCREMENT,
  snapshot_id BIGINT NOT NULL,
  codigo_pedido VARCHAR(40) NOT NULL,
...
CREATE TABLE simulation_report_route_step (
  id BIGINT NOT NULL AUTO_INCREMENT,
...
CREATE TABLE simulation_report_flight_segment (
  id BIGINT NOT NULL AUTO_INCREMENT,
  snapshot_id BIGINT NOT NULL,
...
CREATE TABLE simulation_report_cancellation (
  id BIGINT NOT NULL AUTO_INCREMENT,
  snapshot_id BIGINT NOT NULL,
  flight_id BIGINT NOT NULL,
  fecha_cancelacion DATE NOT NULL,
...
CREATE TABLE simulation_report_impact (
  id BIGINT NOT NULL AUTO_INCREMENT,
  snapshot_id BIGINT NOT NULL,
  codigo_pedido VARCHAR(40) NOT NULL,
