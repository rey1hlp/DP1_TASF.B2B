...
export default function SemaphoreRangeControl({
  ...
  return (
    <div className="range-field">
      <div className="range-field-label">{label}</div>
      ...
      <div className="range-list">
        <div className="range-row">
          <span className="range-dot range-dot-green" aria-hidden="true" />
          <input
            ...
            aria-label="Límite superior del rango verde"
          />
          <span className="range-value">{`0% – ${greenMax}%`}</span>
        </div>

        <div className="range-row">
          <span className="range-dot range-dot-amber" aria-hidden="true" />
          <input
            ...
            aria-label="Límite superior del rango ámbar"
          />
          <span className="range-value">{`${greenMax + 1}% – ${amberMax}%`}</span>
        </div>

        <div className="range-row">
          <span className="range-dot range-dot-red" aria-hidden="true" />
          <div className="range-static" />
          <span className="range-value">{`${amberMax + 1}% – 100%`}</span>
        </div>
      </div>
    </div>
  )
